...
export const CompanyProfileSkeleton = () => {
  return (
    <div className="grid animate-pulse grid-cols-1 gap-x-[20px] gap-y-[15px] sm:grid-cols-2">
      ...
      <div className="flex flex-col gap-2">
        <div className="h-4 w-14 rounded-sm bg-gray-200" />
        <div className="h-[46px] rounded-sm bg-gray-200" />
      </div>
      ...
      <div className="flex flex-col gap-2 sm:col-span-2">
        <div className="h-4 w-24 rounded-sm bg-gray-200" />
        <div className="h-[400px] rounded-sm bg-gray-200" />
      </div>
