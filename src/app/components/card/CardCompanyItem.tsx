...
export const CardCompanyItem = ({
  ...
  return (
    <>
      <Link
        href={link}
        className="border-job-gray relative overflow-hidden rounded-[8px] border transition-all duration-300 hover:shadow-xl"
        style={{
      ...
      >
        ...
        <div className="relative">
          ...
          <h3 className="text-job-secondary mx-2 mb-4 line-clamp-2 min-h-[42px] text-center text-sm font-bold sm:mx-4 sm:mb-[24px] sm:min-h-[54px] sm:text-lg">
            {name}
          </h3>
